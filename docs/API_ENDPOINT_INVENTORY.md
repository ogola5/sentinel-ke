...
| `POST` | `/v1/ai/drift-reports/run` | `ai` | `backend.app.api.ai:run_drift_report` |
...
| `GET` | `/v1/ai/forecast` | `ai` | `backend.app.api.ai:ai_risk_forecast` |
| `GET` | `/v1/ai/forecast/scenario` | `ai` | `backend.app.api.ai:ai_scenario_forecast` |
| `GET` | `/v1/ai/gnn/domain-health` | `ai` | `backend.app.api.ai:gnn_domain_health` |
| `GET` | `/v1/ai/gnn/latest-runs` | `ai` | `backend.app.api.ai:latest_gnn_runs` |
...
| `GET` | `/v1/ai/indicators/summary` | `ai` | `backend.app.api.ai:threat_indicators_summary` |
| `GET` | `/v1/ai/input-anomalies` | `ai` | `backend.app.api.ai:list_input_anomalies` |
| `GET` | `/v1/ai/judge-readiness` | `ai` | `backend.app.api.ai:judge_readiness_summary` |
...
| `POST` | `/v1/ai/query` | `ai` | `backend.app.api.ai:nl_copilot_query` |
...
| `GET` | `/v1/ai/tool-attribution` | `ai` | `backend.app.api.ai:tool_attribution` |
| `GET` | `/v1/ai/tools/summary` | `ai` | `backend.app.api.ai:tools_summary` |
| `GET` | `/v1/ai/trust/entity` | `ai` | `backend.app.api.ai:entity_trust_summary` |
| `GET` | `/v1/ai/trust/summary` | `ai` | `backend.app.api.ai:platform_trust_summary` |
...
| `GET` | `/v1/cases/recent` | `cases` | `backend.app.cases.api:list_recent_cases` |
...
| `GET` | `/v1/defense/actions/catalog` | `defense` | `backend.app.api.defense:get_action_catalog` |
...
| `GET` | `/v1/defense/incidents/actions` | `defense` | `backend.app.api.defense:list_incident_actions` |
...
| `POST` | `/v1/defense/webhooks/self-test/receiver` | `defense` | `backend.app.api.defense:self_test_webhook_receiver` |
| `DELETE` | `/v1/defense/webhooks/{webhook_id}` | `defense` | `backend.app.api.defense:disable_webhook` |
| `POST` | `/v1/demo/bootstrap` | `demo` | `backend.app.api.demo:bootstrap_demo_environment` |
...
| `POST` | `/v1/demo/scenario/replay` | `demo` | `backend.app.demo.scenario_controller:trigger_replay` |
| `POST` | `/v1/demo/scenario/reset` | `demo` | `backend.app.demo.scenario_controller:reset_demo` |
| `POST` | `/v1/demo/scenario/start/{scenario_name}` | `demo` | `backend.app.demo.scenario_controller:start_scenario` |
...
| `GET` | `/v1/federation/edge-status` | `federation` | `backend.app.api.federation:edge_sync_status` |
| `POST` | `/v1/federation/heartbeat` | `federation` | `backend.app.api.federation:receive_heartbeat` |
...
| `GET` | `/v1/federation/warnings` | `federation` | `backend.app.api.federation:list_warnings` |
| `POST` | `/v1/federation/warnings` | `federation` | `backend.app.api.federation:create_warning` |
| `POST` | `/v1/federation/warnings/from-correlation` | `federation` | `backend.app.api.federation:create_warning_from_correlation` |
| `GET` | `/v1/federation/warnings/inbox` | `federation` | `backend.app.api.federation:partner_warning_inbox` |
| `POST` | `/v1/federation/warnings/{warning_id}/ack` | `federation` | `backend.app.api.federation:acknowledge_warning` |
...
| `POST` | `/v1/legal/evidence/bundles/seed` | `legal` | `backend.app.api.legal:seed_evidence_bundles` |
...
| `GET` | `/v1/reports/catalog` | `reports` | `backend.app.api.reports:get_report_catalog` |
| `POST` | `/v1/reports/download` | `reports` | `backend.app.api.reports:download_report` |
| `POST` | `/v1/reports/generate` | `reports` | `backend.app.api.reports:generate_report` |
...
| `GET` | `/v1/stream/events` | `stream` | `backend.app.api.stream:stream_events` |
