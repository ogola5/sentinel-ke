...
1. Start with `docs/JUDGE_TOP15_SCRIPT.md` for the live presentation order.
2. Read `docs/BENCHMARK_SUMMARY.md` for the lane split and headline numbers.
3. Read `docs/TOP15_KPI_EVIDENCE.md` for the concrete KPI/evidence sheet.
4. Read `docs/TOP15_BASELINE_STORY.md` for baseline-vs-model clarity and the lane-safe claim language.
